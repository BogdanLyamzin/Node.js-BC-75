import { registerUser, verifyUser, resendVerifyUser, loginUser, refreshUserSession, logoutUser } from "../services/authServices.js";
...
export const resendVerifyController = async(req, res)=> {
    await resendVerifyUser(req.body.email);
